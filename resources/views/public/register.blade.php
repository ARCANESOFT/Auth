                    ...
                    <div class="panel-body">
                        {{ Form::open(['route' => 'auth::register.post', 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'POST']) }}
                            <div class="form-group{{ $errors->first('username', ' has-error') }}">
                                {{ Form::label('username', trans('auth::users.username'), ['class' => 'col-md-4 control-label']) }}
                                <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->first('first_name', ' has-error') }}">
                                {{ Form::label('first_name', trans('auth::users.first_name'), ['class' => 'col-md-4 control-label']) }}
                                <div class="col-md-6">
                            ...
                            <div class="form-group{{ $errors->first('last_name', ' has-error') }}">
                                {{ Form::label('last_name', trans('auth::users.last_name'), ['class' => 'col-md-4 control-label']) }}
                                <div class="col-md-6">
