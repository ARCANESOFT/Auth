...
@section('content')
    {{ Form::open(['route' => ['auth::foundation.users.update', $user->hashed_id], 'method' => 'PUT', 'id' => 'updateUserForm', 'class' => 'form form-loading']) }}
        <div class="row">
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        {{ link_to_route('auth::foundation.users.show', 'Cancel', [$user->hashed_id], ['class' => 'btn btn-sm btn-default']) }}
            ...
            <div class="col-md-6">
                @include('auth::foundation.users._partials.roles-checkbox', [
